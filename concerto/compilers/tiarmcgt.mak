...
$(_MODULE)_DEFS += xdc_target_name__=ti/targets/arm/elf/R5F xdc_target_types__=ti/targets/arm/elf/std.h
...
$(_MODULE)_LDFLAGS  := $($(_MODULE)_CFLAGS) -z --warn_sections --reread_libs $($(_MODULE)_LINKER_CMD_FILES)
