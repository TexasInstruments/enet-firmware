...
_MODULE_VARS := ENTRY DEFS CFLAGS CPPFLAGS LDFLAGS STATIC_LIBS SHARED_LIBS SYS_STATIC_LIBS
...
_MODULE_VARS += XDC_BLD_FILE XDC_CFG_FILE XDC_IDIRS XDC_PLATFORM LINKER_CMD_FILES ADDITIONAL_STATIC_LIBS
