...
ifeq ($(HOST_PLATFORM),PC)
	ifeq ($(HOST_OS),LINUX)
		TARGET_COMBOS := $(call FILTER_COMBO,LINUX SYSBIOS FREERTOS)
...
COMPILER_ROOTS := TIARMCGT_ROOT_$(TARGET_PLATFORM) GCC_SYSBIOS_ARM_ROOT CGT6X_ROOT CGT7X_ROOT GCC_WINDOWS_ROOT GCC_LINUX_ROOT
