...
const libs_freertos_r5f = {
    common: [
             ...
             "enet-cpsw.am62px.mcu-r5f.ti-arm-clang.${ConfigName}.lib",
             "lwipif-cpsw-freertos.am62px.mcu-r5f.ti-arm-clang.${ConfigName}.lib",
             "lwip-freertos.am62px.mcu-r5f.ti-arm-clang.${ConfigName}.lib",
             "lwip-contrib-freertos.am62px.mcu-r5f.ti-arm-clang.${ConfigName}.lib",
             "ethfw.am62px.mcu-r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
