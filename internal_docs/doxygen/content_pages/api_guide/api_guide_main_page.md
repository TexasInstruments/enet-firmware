...
| [ALLOC_TX](\ref ETHREMOTECFG_CMD_ALLOC_TX)                                 | \ref EthRemoteCfg_AllocTxReq               | \ref EthRemoteCfg_AllocTxRes        |         Y             |         Y          | Allocates Tx channel                      |
| [ALLOC_RX](\ref ETHREMOTECFG_CMD_ALLOC_RX)                                 | \ref EthRemoteCfg_AllocRxReq               | \ref EthRemoteCfg_AllocRxRes        |         Y             |         Y          | Allocates Rx flow                         |
